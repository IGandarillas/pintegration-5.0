...
class PdDeleteProducts extends Command
{
    ...
    public function __construct($deleteProducts)
    {
    ...
    public function syncWithPipedrive(){
        ...
        $res=null;
        foreach($this->deleteProducts as $product){;
            try {
                // https://api.pipedrive.com/v1/
                $res = $client->delete('https://api.pipedrive.com/v1/products/'.$product->id.'?api_token=20054b8b08c4f0fd0f97a8c796143a50d41778e3');
