...
use pintegration\Console\Command;
...
class SyncAllPrestashopProducts extends Command implements SelfHandling, ShouldBeQueued {
	 ...
	 * @var string
	 */
	protected $name = 'command:syncallpsproducts';
